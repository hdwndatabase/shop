    ...
    <li class="each_cat">
        ...
        <div class="right"><ul class="inner"><?php
            ...
            for ($i = 0; $i < 4; $i++) {
                ...
                ?>
                <li class="each_good">
                    <div class="img"><a href="detailPage.php?goodId=<?php echo $good['id'];?>"><img src="/shop/public/images/<?php echo $good['img_name'];?>"></a></div>
                    <div class="title"><a href="detailPage.php?goodId=<?php echo $good['id'];?>"><?php echo $good['title']."  ￥".$good['price'];?></a></div>
                </li>
                <?php
            }
                ?></ul></div>
